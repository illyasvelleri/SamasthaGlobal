...
export default function IntelligenceAssistant() {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  //  ENTRY SCREEN (removed abstract AI presence to avoid gimmicks, changed button shape and text)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  if (!showChat) {
    return (
        ...
        <div className="relative min-h-screen flex items-center justify-center px-5 sm:px-8">
          <div className="w-full max-w-2xl text-center space-y-16 sm:space-y-20 animate-fade-in-up">
            ...
            <div className="pt-4 sm:pt-8">
              <button
                onClick={handleStart}
                className="group relative px-14 sm:px-20 py-5 sm:py-6 text-lg sm:text-xl font-medium bg-emerald-600 text-white rounded-lg transition-all duration-300 hover:bg-emerald-700 active:bg-emerald-800 shadow-[0_4px_24px_rgba(5,150,105,0.2)] hover:shadow-[0_8px_32px_rgba(5,150,105,0.3)] hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
              >
                <span className="relative z-10">Begin Analysis</span>
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-emerald-500/0 via-white/10 to-emerald-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </button>
            </div>
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  //  AI WORKSPACE (adjusted shapes to softly rounded, added bg for assistant messages, changed input/send to match guidelines)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-emerald-50/20 to-stone-100 relative animate-fade-in">
      ...
      <main className="relative flex-1 w-full max-w-[1100px] mx-auto flex flex-col px-5 sm:px-8 md:px-12 lg:px-16 pt-16">
        <div className="flex-1 overflow-y-auto py-12 sm:py-16 md:py-20 pb-40 sm:pb-48">
          <div className="space-y-10 sm:space-y-12 pb-20">
            {messages.map((msg, i) => (
              ...
              >
                {/* Message container (system-level, not bubbles) */}
                <div
                  className={`prose prose-emerald max-w-none text-base sm:text-[15.5px] leading-relaxed font-light tracking-wide p-6 rounded-lg shadow-sm border ${msg.role === 'user'
                    ? 'bg-white/90 border-emerald-600/15 text-stone-900'
                    : 'bg-emerald-50/50 border-emerald-600/10 text-stone-800'
                    }`}
                >
                  {msg.role === 'assistant' ? (
                  ...
                  <div className="space-y-3 pt-2">
                    {msg.buttons.map((btn, idx) => (
                      <button
                        ...
                        className="group w-full text-left px-6 py-4 bg-white/90 border border-emerald-600/12 rounded-lg hover:bg-white hover:border-emerald-600/25 hover:shadow-md transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] flex items-center justify-between"
                      >
            ...
            {isThinking && (
              <div className="flex justify-start animate-fade-in">
                <div className="flex items-center gap-3 px-6 py-4 rounded-lg bg-emerald-50/50 border border-emerald-600/10 shadow-sm">
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[1000] px-4 pb-4 md:px-8 md:pb-6 md:left-1/2 md:-translate-x-1/2 bg-gradient-to-t from-stone-50 via-stone-50/95 to-transparent pt-10 pb-8 px-5 sm:px-8 lg:px-12">
          <form onSubmit={handleChatSubmit} className="max-w-4xl mx-auto">
            <div className="relative">
              <div className="bg-white/70 backdrop-blur-xl border border-emerald-600/15 rounded-xl overflow-hidden shadow-[0_4px_24px_rgba(5,150,105,0.08)] focus-within:border-emerald-600/30 focus-within:bg-white/85 focus-within:shadow-[0_8px_32px_rgba(5,150,105,0.12)] transition-all duration-300 flex items-center">
                <input
                  value={inputValue}
                ...
                <button
                  ...
                  className={`px-6 py-4 m-2 rounded-lg font-medium transition-all duration-300 ${inputValue.trim() && !isThinking
